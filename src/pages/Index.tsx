        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-law-blue max-w-2xl mx-auto">
              Upload your legal contract and ask questions in plain English. 
              Our AI-powered analysis will provide you with quick, accurate insights.
            </p>
          </div>
            ...
            <div className="mt-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="law-card text-center">
                  ...
                  <h3 className="text-lg font-semibold text-law-navy mb-2">Upload Contract</h3>
                ...
                <div className="law-card text-center">
                  ...
                  <h3 className="text-lg font-semibold text-law-navy mb-2">Ask Questions</h3>
                  <p className="text-law-gray text-sm">
                ...
                <div className="law-card text-center">
                  ...
                  <h3 className="text-lg font-semibold text-law-navy mb-2">Get Insights</h3>
                  <p className="text-law-gray text-sm">
